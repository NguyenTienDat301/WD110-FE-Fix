        ...
        <section className="section block-blog-single">
          <div className="container">
            ...
            <div className="content-detail">
              ...
              <p>
                Tuy nhiên, sự hưng phấn của trận đấu thường khiến bạn không muốn
                cởi bỏ bộ trang phục thi đấu ngay lập tức. Nhưng những bộ quần
                áo đấu truyền thống lại không phải lúc nào cũng mang lại sự
                thoải mái cho những phút giây thư giãn sau đó. Vậy sẽ ra sao nếu
                có những bộ quần áo bóng đá vừa thể hiện trọn vẹn tinh thần sân
                cỏ, vừa mang lại sự thoải mái tuyệt đối để bạn có thể mặc trong
                mọi hoạt động hàng ngày? Điều này sẽ mang đến một trải nghiệm
                liền mạch, giúp bạn sống trọn từng khoảnh khắc với đam mê của
                mình. Trong bài viết này, chúng ta sẽ cùng khám phá những bộ
                trang phục bóng đá đa năng có thể làm được điều đó.
              </p>
              <div className="box-experiences">
                <div className="row">
                  <div className="col-lg-4">
                    <strong className="font-xl-bold">12 năm</strong>
                    <p className="font-md neutral-500">
                      Chúng tôi có hơn 12 năm kinh nghiệm làm việc.
                    </p>
                  </div>
                  <div className="col-lg-4">
              ...
              <p>
                Việc phải thay đổi trang phục ngay sau trận đấu có thể làm gián
                đoạn mạch cảm xúc. Nhưng sẽ ra sao nếu có những bộ quần áo bóng
                đá vừa giúp bạn cháy hết mình cùng trận đấu, vừa đủ thoải mái để
                bạn tiếp tục các hoạt động thư giãn ngay sau đó? Điều này sẽ
                giúp trải nghiệm hâm mộ của bạn trở nên liền mạch và trọn vẹn
                hơn rất nhiều! Sứ mệnh của chúng tôi là tạo ra những bộ trang
                phục có thể làm được điều đó.
              </p>
            </div>
          </div>
