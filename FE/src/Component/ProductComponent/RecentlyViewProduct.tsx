    ...
    <div className="col-lg-3 col-sm-6">
      <div className="cardProduct wow fadeInUp">
        <div className="cardImage">
          {isHot && <label className="lbl-hot">hot</label>}
          <a href="product-single.html">
            <img className="imageMain" src={mainImg} alt={title} />
            <img className="imageHover" src={hoverImg} alt={title} />
          </a>
        ...
        <div className="cardInfo">
          <a href="product-single.html">
            <h6 className="font-md-bold cardTitle">{title}</h6>
          </a>
          <p className="font-lg cardDesc">{price}</p>
        </div>
      </div>
    </div>
  );
    ...
    <section className="section block-may-also-like">
      <div className="container">
        <div className="text-center mb-35">
          <h4 className="text-uppercase brand-1 brush-bg mb-15">
            Recently Viewed Products
          </h4>
          <p className="font-lg neutral-500">
            Add these amazing products to your cart
          </p>
        </div>
        <div className="row">
          <ProductCard
            mainImg={ProductOne}
            hoverImg={ProductFour}
          ...
          <ProductCard
            mainImg={ProductOne}
            hoverImg={ProductFour}
            title="Cool Hoodie 2024"
            price="$25.00"
          />
          <ProductCard
            mainImg={ProductOne}
            hoverImg={ProductFour}
            title="Football Jersey Limited"
            price="$35.00"
          />
          <ProductCard
            mainImg={ProductOne}
...
const InstagramGallery = () => {
  const igImages = [Ig, IgTwo, IgThree, IgFour, IgFive, IgOne];
      ...
      <div className="box-gallery-instagram">
        <div className="box-gallery-instagram-inner">
          {igImages.map((src, index) => (
            <div
              key={index}
              className={`gallery-item wow ${
                index % 2 === 0 ? "fadeInLeft" : "fadeInRight"
              }`}
            >
              <img src={src} alt="kidify" />
            </div>
          ))}
        </div>
      </div>
