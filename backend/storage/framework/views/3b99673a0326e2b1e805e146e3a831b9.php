    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-calendar-alt"></i> Chọn khoảng thời gian thống kê</h3>
            </div>
            <div class="card-body">
                <form id="time-filter-form" method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="row g-3 align-items-end">
                    <div class="col-md-4">
                        <label for="start_date" class="form-label fw-bold">
                            <i class="fas fa-calendar-day"></i> Từ ngày:
                        </label>
                        <input type="date" id="start_date" name="start_date" class="form-control" value="<?php echo e($startDate ? $startDate->format('Y-m-d') : ''); ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="end_date" class="form-label fw-bold">
                            <i class="fas fa-calendar-day"></i> Đến ngày:
                        </label>
                        <input type="date" id="end_date" name="end_date" class="form-control" value="<?php echo e($endDate ? $endDate->format('Y-m-d') : ''); ?>">
                    </div>
                    <div class="col-md-2">
    ...
    <div class="row mt-4">
        <div class="col-md-3">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3><?php echo e(number_format($totalRevenue, 0, ',', '.')); ?> VND</h3>
                    <p>Tổng Doanh Thu</p>
                </div>
                <div class="icon">
                ...
                <?php if(isset($revenueChange)): ?>
                    <span class="small-box-footer">
                        <i class="fas fa-arrow-<?php echo e($revenueChange >= 0 ? 'up' : 'down'); ?>"></i>
        ...
        <div class="col-md-3">
            <div class="small-box bg-warning">
                ...
                <?php if(isset($ordersChange)): ?>
                    <span class="small-box-footer">
                        <i class="fas fa-arrow-<?php echo e($ordersChange >= 0 ? 'up' : 'down'); ?>"></i>
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>