...
<?php $__env->startSection('content_admin'); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <h1 class="m-0 text-center">Danh sách đơn hàng</h1>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('orders.index')); ?>" method="GET" class="row g-2 align-items-center mb-3">
                    <div class="col-md-3">
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/order/index.blade.php ENDPATH**/ ?>