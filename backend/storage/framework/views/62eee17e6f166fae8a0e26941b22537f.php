        ...
        <div class="container-fluid">
            <div class="card card-outline card-success">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a class="btn btn-success" href="<?php echo e(route('vouchers.create')); ?>">
                        <i class="fas fa-plus"></i> Thêm mới voucher
                    </a>
                </div>
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('vouchers.index')); ?>" id="filterForm" class="mb-3">
                        <div class="row">
                            <div class="col-md-2">
                                <select name="status" id="status" class="form-select" onchange="document.getElementById('filterForm').submit()">
                                    ...
                                    <option value="1" class="text-dark" <?php echo e(request('status') == '1' ? 'selected' : ''); ?>>Đang hoạt động</option>
                                    <option value="0" class="text-dark" <?php echo e(request('status') == '0' ? 'selected' : ''); ?>>Không hoạt động</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <select name="expiry_status" id="expiry_status" class="form-select" onchange="document.getElementById('filterForm').submit()">
                                    <option value="" class="text-dark">Tất cả thời hạn</option>
                                    <option value="valid" class="text-dark" <?php echo e(request('expiry_status') == 'valid' ? 'selected' : ''); ?>>Còn hạn</option>
                                    <option value="expired" class="text-dark" <?php echo e(request('expiry_status') == 'expired' ? 'selected' : ''); ?>>Đã hết hạn</option>
                                </select>
                            </div>
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/vouchers/index.blade.php ENDPATH**/ ?>