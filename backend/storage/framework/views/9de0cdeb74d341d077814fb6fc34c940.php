...
<?php $__env->startSection('content_admin'); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <h1 class="m-0 text-center">Thêm mới sản phẩm</h1>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="img_thumb" id="img_thumb" class="form-control" accept="image/*" required onchange="previewImage()">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="imagePreviewContainer" style="display: none;">
                        ...
                        <img id="imagePreview" src="" alt="Selected Image" style="width: 150px; height: 100px; margin-top: 10px;" class="rounded" />
                    </div>
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mb-5 mt-4">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save"></i> Tạo sản phẩm</button>
                        <a href="<?php echo e(route('products.index')); ?>" class="btn btn-secondary btn-lg ms-2"><i class="fas fa-arrow-left"></i> Quay lại</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/products/createproduct.blade.php ENDPATH**/ ?>