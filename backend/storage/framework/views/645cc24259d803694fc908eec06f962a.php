                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8"><code><?php echo e($product->id); ?></code></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Slug:</strong></div>
                                        <div class="col-sm-8"><code><?php echo e($product->slug ?? 'Chưa có slug'); ?></code></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Danh mục:</strong></div>
                                        <div class="col-sm-8"><span class="badge bg-info"><?php echo e($product->categories->name ?? 'Không có'); ?></span></div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Lượt xem:</strong></div>
                                        <div class="col-sm-8"><?php echo e(number_format($product->view ?? 0)); ?></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Ngày tạo:</strong></div>
                                        <div class="col-sm-8"><?php echo e($product->created_at ? $product->created_at->format('d/m/Y H:i') : 'N/A'); ?></div>
                                    </div>
                                </div>
                            </div>
                            <?php if($product->description): ?>
                                <div class="mt-4">
                                    <h6>Mô tả:</h6>
                                    <div class="border p-3 rounded bg-light"><?php echo nl2br(e($product->description)); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo e(route('product-variants.index', $product->id)); ?>" class="btn btn-sm btn-primary">Xem tất cả</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $product->variants->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><span class="badge bg-info"><?php echo e($variant->size->size ?? 'N/A'); ?></span></td>
                                            <td><span class="badge bg-secondary"><?php echo e($variant->color->name_color ?? 'N/A'); ?></span></td>
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/products/show.blade.php ENDPATH**/ ?>