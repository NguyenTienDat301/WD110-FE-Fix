        ...
        <div class="card card-outline card-success">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <form method="GET" action="<?php echo e(route('products.index')); ?>" class="mr-2">
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/products/index.blade.php ENDPATH**/ ?>