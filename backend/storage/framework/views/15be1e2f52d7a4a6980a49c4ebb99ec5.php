            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <h5 class="mb-3">Sản phẩm: <strong><?php echo e($product->name); ?></strong></h5>
                            <div class="mb-2">
                                <span class="badge bg-info">SKU: <?php echo e($product->sku); ?></span>
                                <span class="badge bg-success">Giá: <?php echo e(number_format($product->price)); ?>đ</span>
                                <span class="badge bg-warning text-dark">Số lượng: <?php echo e($product->quantity); ?></span>
                            </div>
                            <a href="<?php echo e(route('product-variants.index', $product->id)); ?>" class="btn btn-secondary mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="size_id">Kích thước <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="color_id">Màu sắc <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="price_sale">Giá sale (không bắt buộc)</label>
                                            <div class="input-group">
                    ...
                    <div class="card card-info mb-3">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="mb-2">
                                    <span class="badge bg-info mr-1"><?php echo e($variant->size->size ?? 'N/A'); ?></span>
...
<?php echo $__env->make('Layout.Layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\New folder (2)\backend\resources\views/product-variants/edit.blade.php ENDPATH**/ ?>