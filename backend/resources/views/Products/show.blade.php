                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8"><code>{{ $product->id }}</code></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Slug:</strong></div>
                                        <div class="col-sm-8"><code>{{ $product->slug ?? 'Chưa có slug' }}</code></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Danh mục:</strong></div>
                                        <div class="col-sm-8"><span class="badge bg-info">{{ $product->categories->name ?? 'Không có' }}</span></div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">{{ number_format($product->view ?? 0) }}</div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4"><strong>Ngày tạo:</strong></div>
                                        <div class="col-sm-8">{{ $product->created_at ? $product->created_at->format('d/m/Y H:i') : 'N/A' }}</div>
                                    </div>
                                </div>
                            </div>
                            @if ($product->description)
                                <div class="mt-4">
                                    <h6>Mô tả:</h6>
                                    <div class="border p-3 rounded bg-light">{!! nl2br(e($product->description)) !!}</div>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('product-variants.index', $product->id) }}" class="btn btn-sm btn-primary">Xem tất cả</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @foreach ($product->variants->take(10) as $variant)
                                        <tr>
                                            <td><span class="badge bg-info">{{ $variant->size->size ?? 'N/A' }}</span></td>
                                            <td><span class="badge bg-secondary">{{ $variant->color->name_color ?? 'N/A' }}</span></td>
