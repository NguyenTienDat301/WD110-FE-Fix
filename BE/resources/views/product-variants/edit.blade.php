            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <h5 class="mb-3">Sản phẩm: <strong>{{ $product->name }}</strong></h5>
                            <div class="mb-2">
                            ...
                            <a href="{{ route('product-variants.index', $product->id) }}" class="btn btn-secondary mb-3">
                    ...
                    <div class="card card-info mb-3">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="mb-2">
                                    <span class="badge bg-info mr-1">{{ $variant->size->size ?? 'N/A' }}</span>
